...
const chatList = {
    1: {text: 'ようこそ”スタイリングアドバイスチャット”へ！', continue: true, option: 'normal'},
    2: {text: 'ここではコーディネイトに悩むあなたに、最適なスタイリングを提案します。', continue: true, option: 'normal'},
    3: {text: {title: 'Q1', question: 'どこに着ていく予定ですか？', choices: ['遊園地や水族館', 'ショッピング', '観光地', 'その他']}, continue: false, option: 'choices', questionNextSupport: true}, // questionNextSupportは次に質問に対する詳細を投稿するかどうか
    // userCount1：豆知識
    4: {text: ['男性：快適なデニムジーンズとカラフルなTシャツ、女性：ブラウスとキュロットスカート', '男性：カーディガンにチノパンツ、女性：Tシャツにワイドパンツ', '男性：日差しを防ぐバケツハットにポロシャツ、女性：クロスボディバックにジレ', '男性：オーバーサイズのTシャツとスキニーパンツ、女性：カットアウトデザインのアイテム'], continue: true, option: 'normal'},
    ...
    10: {text: 'ここでファッション豆知識です！', continue: true, option: 'normal'},
    11: {text: {title: 'Q2', question: '「セーター」は、もともとは何のために作られた？', choices: ['スポーツ選手の減量目的のため', '冬の防寒対策のため', '戦争で傷ついた兵士のため'], answer: '0'}, continue: false, option: 'choices'},
    // userCount4：豆知識
    12: {text: {qTrue: '', qFalse:'残念！正解は"スポーツ選手の減量目的のため"でした。'}, continue: true, option: 'normal'},
    13: {text: '', continue: true, option: 'normal'},
    14: {text: {title: '満足度調査', question: 'このスタイリングアドバイスの満足度を5段階で教えてください。', choices: ['5', '4', '3', '2', '1']}, continue: false, option: 'choices'},
    // userCount5：満足度
